    ...
    <div className="container-fluid py-5">
        <div className="row px-xl-5">
            ...
            <div className="col-lg-7 pb-5">
                ...
                <p className="mb-4">Volup erat ipsum diam elitr rebum et dolor. Est nonumy elitr erat
                 diam stet sit clita ea. Sanc invidunt ipsum et, labore clita
                  lorem magna lorem ut. Erat lorem duo dolor no sea nonumy. 
